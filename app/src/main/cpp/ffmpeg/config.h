...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=./android_single_lib/armeabi-v7a --enable-cross-compile --arch=arm --cc=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/darwin-x86_64/bin/arm-linux-androideabi- --sysroot=/Users/niuzilin/Library/Android/ndk/android-ndk-r14b/platforms/android-21/arch-arm --enable-neon --disable-hwaccels --enable-static --disable-shared --disable-runtime-cpudetect --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-asm --enable-small --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-debug --enable-gpl --disable-avdevice --disable-indevs --disable-outdevs --disable-avresample --extra-cflags='-Os -fpic -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb -I./android_single_lib/armeabi-v7a/include' --extra-ldflags='-lc -lm -ldl -llog -lgcc -lz -L./android_single_lib/armeabi-v7a/lib' --extra-cflags='-Os -fpic -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb -I/Users/niuzilin/资料啊/ffmpeg_source/FFmpeg/x264/android_lib_so/armeabi-v7a/include' --extra-ldflags='-lc -lm -ldl -llog -lgcc -lz -L/Users/niuzilin/资料啊/ffmpeg_source/FFmpeg/x264/android_lib_so/armeabi-v7a/lib' --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-network --enable-libx264 --enable-bsfs --enable-postproc --enable-filters --enable-encoders --enable-encoder='libx264,mpeg4,aac,pcm_alaw' --disable-decoders --enable-decoder='mjpeg,mpeg4,h264,flv,hevc,aac,aac_latm,vp8,vp9,mp3,pcm_alaw,h264_mediacodec,hevc_mediacodec,mpeg4_mediacodec,vp9_mediacodec' --disable-muxers --enable-muxer='mp4,mov,mjpeg' --disable-parsers --enable-parser='aac,aac_latm,h264,flac,hevc' --disable-protocols --enable-protocol='async,concat,ffrtmphttp,rtmp*,rtmp,rtmpt,rtp,tcp' --disable-protocol='bluray,ffrtmpcrypt,gopher,icecast,librtmp*,libssh,md5,mmsh,mmst,sctp,srtp,subfile,unix' --enable-jni --enable-mediacodec --disable-demuxers --enable-demuxer='aac,mov,avi,concat,live_flv,hevc,flac,flv,rtsp,sdp,rtp,mjpeg,mp3,mpegps,mpegts,mpegvideo,data,webm_dash_manifest' --cpu=armv7-a"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "./android_single_lib/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "./android_single_lib/armeabi-v7a/share/ffmpeg"
